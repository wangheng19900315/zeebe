...
public abstract class TopicSubscriberRecordImpl extends RecordImpl
{
    ...
    public TopicSubscriberRecordImpl(ZeebeObjectMapper objectMapper, RecordMetadata.RecordType recordType)
    {
        super(objectMapper, recordType, RecordMetadata.ValueType.SUBSCRIBER);
    }
